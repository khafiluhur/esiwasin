...
class CreateApprovelReviuLaporanKeuangan extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('approvel_reviu_laporan_keuangan', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('approvel_reviu_laporan_keuangan');
    }
}

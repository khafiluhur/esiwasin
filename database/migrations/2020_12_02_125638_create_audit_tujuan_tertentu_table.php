...
class CreateAuditTujuanTertentuTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('audit_tujuan_tertentu', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('audit_tujuan_tertentu');
    }
}

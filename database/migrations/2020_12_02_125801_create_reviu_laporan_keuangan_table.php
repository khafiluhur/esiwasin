...
class CreateReviuLaporanKeuanganTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reviu_laporan_keuangan', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('reviu_laporan_keuangan');
    }
}

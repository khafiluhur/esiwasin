...
class CreateApprovelAuditTujuanTertentuTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('approvel_audit_tujuan_tertentu', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('approvel_audit_tujuan_tertentu');
    }
}

...
class CreateApprovelAuditKeuanganTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('approvel_audit_keuangan', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('approvel_audit_keuangan');
    }
}

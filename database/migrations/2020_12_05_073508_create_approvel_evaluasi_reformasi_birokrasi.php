...
class CreateApprovelEvaluasiReformasiBirokrasi extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('approvel_evaluasi_reformasi_birokrasi', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->integer('evaluasi_reformasi_birokrasi');
    ...
    {
        Schema::dropIfExists('approvel_evaluasi_reformasi_birokrasi');
    }
}

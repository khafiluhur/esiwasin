...
class CreateApprovelEvaluasiSakip extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('approvel_evaluasi_sakip', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('approvel_evaluasi_sakip');
    }
}

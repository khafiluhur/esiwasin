...
class CreateApprovelKoordinasi extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('approvel_koordinasi', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->integer('koordinasi');
            ...
            $table->integer('users_anggota');
            $table->integer('status_anggota');
            $table->string('tanggal_anggota');
            $table->string('jam_anggota');
            $table->text('komentar_anggota');
    ...
    {
        Schema::dropIfExists('approvel_koordinasi');
    }
}

...
class CreateApprovelEvaluasiSpip extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('approvel_evaluasi_spip', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->integer('evaluasi_spip');
    ...
    {
        Schema::dropIfExists('approvel_evaluasi_spip');
    }
}

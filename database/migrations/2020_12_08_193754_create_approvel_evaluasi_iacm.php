...
class CreateApprovelEvaluasiIacm extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('approvel_evaluasi_iacm', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('approvel_evaluasi_iacm');
    }
}

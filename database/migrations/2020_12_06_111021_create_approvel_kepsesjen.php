...
class CreateApprovelKepsesjen extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('approvel_kepsesjen', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->integer('kepsesjen');
    ...
    {
        Schema::dropIfExists('approvel_kepsesjen');
    }
}

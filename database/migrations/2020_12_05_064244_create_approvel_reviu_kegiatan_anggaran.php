...
class CreateApprovelReviuKegiatanAnggaran extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('approvel_reviu_kegiatan_anggaran', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->integer('reviu_kegiatan_anggaran');
    ...
    {
        Schema::dropIfExists('approvel_reviu_kegiatan_anggaran');
    }
}

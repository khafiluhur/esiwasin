<form action="{{ route('keuangan.audit') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-6 float-left">
            <div class="form-group">
                ...
                <select class="custom-select" id="ketua" name="ketua">
                    ...
                    <option value="{{ $u->id }}" {{ ( $u->id == $data1->ketua ) ? 'selected' : '' }}>{{ $u->nama }}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
                ...
                <div class="">
                    <div class="form-group">
                        <div class="input-daterange input-group" data-date-format="dd/mm/yyyy" data-week-start="1" data-autoclose="true" data-today-highlight="true">
                            <input type="text" class="form-control" id="tanggal_audit_from" name="tanggal_audit_from" placeholder="From" data-week-start="1" data-autoclose="true" data-today-highlight="true" value="{{ $data1->tanggal_audit_from }}">
                            <div class="input-group-prepend input-group-append">
                                <span class="input-group-text font-w600">
                                    s/d
                                </span>
                            </div>
                            <input type="text" class="form-control" id="tanggal_audit_to" name="tanggal_audit_to" placeholder="To" data-week-start="1" data-autoclose="true" data-today-highlight="true" value="{{ $data1->tanggal_audit_to }}">
                        </div>
                    </div>    
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-10 float-left pl-0 pr-0 input-group mb-3">
                        ...
                        <div class="input-group-append">
                            <a href="{{ route('audit.keuangan.download', ['file' => $u->filename ]) }}" class="input-group-text" id="basic-addon2"><i class="fas fa-download"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="input-group custom-file hdtuto control-group lst increment">
                        ...
                        <div class="input-group-btn col-2 float-left"> 
                            <button class="btn btn-success" id="add_kertas_keuangan" type="button"><i class="fas fa-plus"></i></button>
                        </div>
                    </div>
    ...
    <div class="content">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="temuan_judul" name="temuan_judul" value="{{ $data1->temuan_judul }}">
            </div>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text bg-white">
                ...
                <input type="text" class="form-control" id="temuan_kondisi" name="temuan_kondisi" value="{{ $data1->temuan_kondisi }}">
            </div>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text bg-white">
                ...
                <input type="text" class="form-control" id="temuan_kriteria" name="temuan_kriteria" value="{{ $data1->temuan_kriteria }}">
            </div>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text bg-white">
                ...
                <textarea class="form-control" id="temuan_sebab" name="temuan_sebab" rows="4" value="">{{ $data1->temuan_sebab }}</textarea>
            </div>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text bg-white">
                ...
                <textarea class="form-control" id="temuan_akibat" name="temuan_akibat" rows="4">{{ $data1->temuan_akibat }}</textarea>
            </div>
        </div>
    </div>    
    ...
    <div class="block-header block-header-default">
        ...
        <div class="block-options">
            @if($data1->is_status == 1)
            <button type="submit" class="btn btn-sm btn-secondary" name="simpan" value="simpan" disabled>
                Simpan
            </button>
            ...
            @else
            <button type="submit" class="btn btn-sm btn-secondary" name="simpan" value="simpan">
                Simpan
            </button>

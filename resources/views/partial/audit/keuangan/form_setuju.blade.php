<form action="{{ route('setuju.keuangan') }}" method="POST" enctype="multipart/form-data">
{{ csrf_field() }}
...
<div class="col-12">
    <div class="col-6 float-left">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="text" id="created_by" name="created_by" value="{{ $data1->users_ketua }}" disabled>
        </div>
        @if(Auth::user()->level == 1)
            <div class="form-group">
                <label>Anggota Tim</label>
            ...
            <div class="">
                <div class="form-group">
                    <div class="input-daterange input-group" data-date-format="dd/mm/yyyy" data-week-start="1" data-autoclose="true" data-today-highlight="true">
                        <input type="text" class="form-control" id="tanggal_audit_from" name="tanggal_audit_from" placeholder="From" data-week-start="1" data-autoclose="true" data-today-highlight="true" value="{{ $data1->tanggal_audit_from }}" disabled>
                        <div class="input-group-prepend input-group-append">
                            <span class="input-group-text font-w600">
                                s/d
                            </span>
                        </div>
                        <input type="text" class="form-control" id="tanggal_audit_to" name="tanggal_audit_to" placeholder="To" data-week-start="1" data-autoclose="true" data-today-highlight="true" value="{{ $data1->tanggal_audit_to }}" disabled>
                    </div>
                </div>    
            </div>
        </div>
...
<div class="content">
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control" id="temuan_judul" name="temuan_judul" value="{{ $data1->temuan_judul }}" disabled>
        </div>
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text bg-white">
            ...
            <input type="text" class="form-control" id="temuan_kondisi" name="temuan_kondisi" value="{{ $data1->temuan_kondisi }}" disabled>
        </div>
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text bg-white">
            ...
            <input type="text" class="form-control" id="temuan_kriteria" name="temuan_kriteria" value="{{ $data1->temuan_kriteria }}" disabled>
        </div>
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text bg-white">
            ...
            <textarea class="form-control" id="temuan_sebab" name="temuan_sebab" rows="4" value="" disabled>{{ $data1->temuan_sebab }}</textarea>
        </div>
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text bg-white">
            ...
            <textarea class="form-control" id="temuan_akibat" name="temuan_akibat" rows="4" disabled>{{ $data1->temuan_akibat }}</textarea>
        </div>
    </div>
</div>   

<form action="{{ route('tujuantertentu.audit') }}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
    ...
    <div class="col-6 float-left">
        <div class="form-group">
            ...
            <select class="custom-select" id="ketua" name="ketua">
                ...
                <option value="{{ $u->id }}" {{ ( $u->id == $data3->ketua ) ? 'selected' : '' }}>{{ $u->nama }}</option>
                @endforeach
            </select>
        </div>
        <div class="form-group">
            <label for="nomor_st">Nomor ST</label><span class="text-danger">*</span>
            <input class="form-control" type="text" id="nomor_st" name="nomor_st" value="{{ $data3->nomor_st }}">
            <input class="form-control" type="hidden" id="kode2" name="kode" value="{{ $data3->kode }}">
        </div>
    </div>
            ...
            <div class="">
                <div class="form-group">
                    <div class="input-daterange input-group" data-date-format="dd/mm/yyyy" data-week-start="1" data-autoclose="true" data-today-highlight="true">
                        <input type="text" class="form-control" id="tanggal_audit_from" name="tanggal_audit_from" placeholder="From" data-week-start="1" data-autoclose="true" data-today-highlight="true" value="{{ $data3->tanggal_audit_from }}">
                        <div class="input-group-prepend input-group-append">
                            <span class="input-group-text font-w600">
                                s/d
                            </span>
                        </div>
                        <input type="text" class="form-control" id="tanggal_audit_to" name="tanggal_audit_to" placeholder="To" data-week-start="1" data-autoclose="true" data-today-highlight="true" value="{{ $data3->tanggal_audit_to }}">
                    </div>
                </div>    
            </div>
        </div>
        <div class="">
            <div class="form-group">
                ...
                <div class="input-group-btn col-2 float-left"> 
                    <a href="{{ route('delete.tujuantertentu', ['id' => $u->kode_audit_tujuan_tertentu ]) }}" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                    <input class="form-control" type="hidden" id="kode" name="kode" value="{{ $u->kode_audit_tujuan_tertentu }}">
                </div> 
                @endforeach
                <div class="input-group custom-file hdtuto control-group lst increment" >
                    ...
                    <div class="input-group-btn col-2 float-left"> 
                        <button class="btn btn-success" id="add_kertas_tujuan" type="button"><i class="fas fa-plus"></i></button>
                    </div>
                </div>
                <div class="clone input-group custom-file hdtuto control-group lst" id="upload_kertas_tujuan" style="margin-top:10px" >
                    <div class="col-10 float-left">
                        <input type="file" id="kertas_kerja" name="kertas_kerja[]" class="myfrm form-control custom-file-input" data-toggle="custom-file-input" value="{{ old('kertas_kerja') }}" multiple="multiple">
                        <label class="custom-file-label" for="kertas_kerja">Dokumen</label>
                    </div>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            <div class="input-group-prepend">
                ...
                <input type="text" class="form-control" id="temuan_judul" name="temuan_judul" value="{{ $data3->temuan_judul }}">
            </div>
        </div>
        <div class="input-group">
            <div class="input-group-prepend">
            ...
            <input type="text" class="form-control" id="temuan_kondisi" name="temuan_kondisi" value="{{ $data3->temuan_kondisi }}">
        </div>
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text bg-white">
            ...
            <input type="text" class="form-control" id="temuan_kriteria" name="temuan_kriteria" value="{{ $data3->temuan_kriteria }}">
        </div>
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text bg-white">
            ...
            <textarea class="form-control" id="temuan_sebab" name="temuan_sebab" rows="4" value="">{{ $data3->temuan_sebab }}</textarea>
        </div>
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text bg-white">
            ...
            <textarea class="form-control" id="temuan_akibat" name="temuan_akibat" rows="4">{{ $data3->temuan_akibat }}</textarea>
        </div>
    </div>
</div>    

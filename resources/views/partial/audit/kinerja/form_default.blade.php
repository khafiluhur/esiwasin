...
<div class="col-12">
    <div class="col-6 float-left">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="hidden" id="kode2" name="kode" value="{{rand()}}">
        </div>
        <div class="form-group">
...
<div class="content">
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <textarea class="form-control" id="temuan_sebab" name="temuan_sebab" rows="4" placeholder="Input Sebab Temua">{{ old('temuan_sebab') }}</textarea>
        </div>
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text bg-white">
            ...
            <textarea class="form-control" id="temuan_akibat" name="temuan_akibat" rows="4" placeholder="Input Akibat Temua" >{{ old('temuan_akibat') }}</textarea>
        </div>
    </div>
</div>  

            ...
            <div class="js-wizard-simple block">
                ...
                <div class="block-content block-content-full tab-content px-md-5" style="min-height: 90%;">
                    ...
                    <div class="tab-pane active" id="audit_keuangan" role="tabpanel">
                        <form action="{{ route('reviu.download', ['id' => $audit->kode ]) }}" method="GET">
                            {{ csrf_field() }}
                                        ...
                                        <div class="">
                                            <div class="form-group">
                                                <div class="input-daterange input-group" data-date-format="dd/mm/yyyy" data-week-start="1" data-autoclose="true" data-today-highlight="true">
                                                    <input type="text" class="form-control" id="tanggal_audit_from" name="tanggal_audit_from" placeholder="From" data-week-start="1" data-autoclose="true" data-today-highlight="true" value="{{$audit->tanggal_reviu_from}}" disabled>
                                                    <div class="input-group-prepend input-group-append">
                                                        <span class="input-group-text font-w600">
                                                            s/d
                                                        </span>
                                                    </div>
                                                    <input type="text" class="form-control" id="tanggal_audit_to" name="tanggal_audit_to" placeholder="To" data-week-start="1" data-autoclose="true" data-today-highlight="true" value="{{$audit->tanggal_reviu_to}}" disabled>
                                                </div>
                                            </div>    
                                        </div>
                                    </div>
                            ...
                            <div class="content">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" id="temuan_akibat" name="temuan_akibat" rows="4" disabled>{{$audit->temuan_penjelasan_reviu}}</textarea>
                                    </div>
                                </div>
                            </div>    

<form action="{{ route('setuju.rkbmn') }}" method="POST" enctype="multipart/form-data">
{{ csrf_field() }}
...
<div class="col-12">
    <div class="col-6 float-left">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="text" id="created_by" name="created_by" value="{{ $data4->users_pembuat }}" disabled>
        </div>
        @else
        <div class="form-group">
            <label>Ketua Tim</label>
            <input class="form-control" type="text" id="created_by" name="created_by" value="{{ $data4->users_ketua }}" disabled>
        </div>
        <div class="form-group">
            <label>Anggota Tim</label>
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="text" id="nomor_st" name="nomor_st" value="{{ $data4->nomor_st }}" disabled>
            <input class="form-control" type="hidden" id="kode2" name="kode" value="{{ $data4->kode }}">
        </div>
    </div>
            ...
            <div class="">
                <div class="form-group">
                    <div class="input-daterange input-group" data-date-format="dd/mm/yyyy" data-week-start="1" data-autoclose="true" data-today-highlight="true">
                        <input type="text" class="form-control" id="tanggal_audit_from" name="tanggal_audit_from" placeholder="From" data-week-start="1" data-autoclose="true" data-today-highlight="true" value="{{ $data4->tanggal_reviu_from }}" disabled>
                        <div class="input-group-prepend input-group-append">
                            <span class="input-group-text font-w600">
                                s/d
                            </span>
                        </div>
                        <input type="text" class="form-control" id="tanggal_audit_to" name="tanggal_audit_to" placeholder="To" data-week-start="1" data-autoclose="true" data-today-highlight="true" value="{{ $data4->tanggal_reviu_to }}" disabled>
                    </div>
                </div>    
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-10 float-left pl-0 pr-0 input-group mb-3">
                    ...
                    <div class="input-group-append">
                        <a href="{{ route('review.rkbmn.download', ['file' => $u->filename ]) }}" class="input-group-text" id="basic-addon2"><i class="fas fa-download"></i></a>
                    </div>
                </div>
                @endforeach
            </div>
...
<div class="content">
    ...
    <div class="form-group">
        <div class="input-group">
            ...
            <textarea class="form-control" id="temuan_sebab" name="temuan_sebab" rows="4" value="" disabled>{{ $data4->temuan_penjelasan_reviu }}</textarea>
        </div>
    </div>
</div>   

...
<div class="col-12">
    <div class="col-6 float-left">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="hidden" id="kode5" name="kode" value="{{rand()}}">
        </div>
        <div class="form-group">
...
<div class="content">
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <textarea class="form-control" id="temuan_akibat" name="temuan_akibat" rows="4" placeholder="Input Penjelasan Temuan" value="{{ old('temuan_akibat') }}"></textarea>
        </div>
    </div>
</div>  

<form action="{{ route('sakip.evaluasi') }}" method="POST" enctype="multipart/form-data">
{{ csrf_field() }}
<h3 style="text-align: center">Evaluasi SAKIP</h3>
            ...
            <div class="">
                <div class="form-group">
                    <div class="input-daterange input-group" data-date-format="dd/mm/yyyy" data-week-start="1" data-autoclose="true" data-today-highlight="true">
                        <input type="text" class="form-control" id="tanggal_audit_from" name="tanggal_audit_from" placeholder="From" data-week-start="1" data-autoclose="true" data-today-highlight="true" value="{{ $data1->tanggal_evaluasi_from }}">
                        <div class="input-group-prepend input-group-append">
                            <span class="input-group-text font-w600">
                                s/d
                            </span>
                        </div>
                        <input type="text" class="form-control" id="tanggal_audit_to" name="tanggal_audit_to" placeholder="To" data-week-start="1" data-autoclose="true" data-today-highlight="true" value="{{ $data1->tanggal_evaluasi_to }}">
                    </div>
                </div>    
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-10 float-left pl-0 pr-0 input-group mb-3">
                    ...
                    <div class="input-group-append">
                        <a href="{{ route('evaluasi.sakip.download', ['file' => $u->filename ]) }}" class="input-group-text" id="basic-addon2"><i class="fas fa-download"></i></a>
                    </div>
                </div>
                <div class="input-group-btn col-2 float-left"> 
                    <a href="{{ route('delete.sakip', ['id' => $u->kode_evaluasi_sakip ]) }}" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                    <input class="form-control" type="hidden" id="kode" name="kode" value="{{ $u->kode_evaluasi_sakip }}">
                </div> 
                @endforeach
                <div class="input-group custom-file hdtuto control-group lst increment" >
                    ...
                    <div class="input-group-btn col-2 float-left"> 
                        <button class="btn btn-success" id="add_kertas_sakip" type="button"><i class="fas fa-plus"></i></button>
                    </div>
                </div>
                <div class="clone input-group custom-file hdtuto control-group lst" id="upload_kertas_sakip" style="margin-top:10px" >
                    <div class="col-10 float-left">
                        <input type="file" id="kertas_kerja" name="kertas_kerja[]" class="myfrm form-control custom-file-input" data-toggle="custom-file-input" value="{{ old('kertas_kerja') }}" multiple="multiple">
                        <label class="custom-file-label" for="kertas_kerja">Dokumen</label>
                    </div>
...
<div class="content">
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <textarea class="form-control" id="temuan_akibat" name="temuan_akibat" rows="4">{{ $data1->temuan_penjelasan }}</textarea>
        </div>
    </div>
</div>    

...
<h3 style="text-align: center">Pemantauan TL LHA</h3>
<div class="col-12">
    <div class="">
        <div class="form-group">
            ...
            <div class="float-right">
                <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-block-normal1">
                    Tambah Temuan
                </button>
            </div>
        </div> 
    ...
    <div class="block">
        ...
        <div class="block-content block-content-full mt-7">
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    @foreach($data2 as $key => $u)
                        <tr>
                            <td class="text-center font-size-sm">{{$key+1}}</td>
                            <td class="font-w600 font-size-sm">{{ $u->keterangan }}</td>
                            <td class="d-none d-sm-table-cell font-size-sm"><a href="{{ route('pemantauan.lh.download', ['file' => $u->berkas_temuan ]) }}"" class="">{{ $u->berkas_temuan }}</a></td>
...
<div class="modal" id="modal-block-normal1" tabindex="-1" role="dialog" aria-labelledby="modal-block-normal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header" style="background-color: #D10102;">
                    <h3 class="block-title">Tambah Temuan TL LHA</h3>
                ...
                <div class="block-content font-size-sm">
                    <div class="card-body">
                        <form method="POST" action="{{ route('lha.pemantauan') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}

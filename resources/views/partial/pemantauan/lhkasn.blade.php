...
<h3 style="text-align: center">Pemantauan LHKASN</h3>
<div class="col-12">
    <div class="">
        <div class="form-group">
            ...
            <div class="float-right">
                <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-block-normal3">
                    Tambah Berkas
                </button>
            </div>
        </div> 
                ...
                <tbody>
                    @foreach($data4 as $key => $u)
                        <tr>
                            ...
                            <td class=""><a href="{{ route('pemantauan.bpk.download', ['file' => $u->id ]) }}"" class="">{{ $u->berkas_temuan }}</a></td>
...
<div class="modal" id="modal-block-normal3" tabindex="-1" role="dialog" aria-labelledby="modal-block-normal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header" style="background-color: #D10102;">
                    <h3 class="block-title">Tambah Temuan LHKASN</h3>
                ...
                <div class="block-content font-size-sm">
                    <div class="card-body">
                        <form method="POST" action="{{ route('lhkasn.pemantauan') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <label>Pangkat</label><span class="text-danger">*</span>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <label>Golongan</label><span class="text-danger">*</span>
                                </div>

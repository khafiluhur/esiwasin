...
<h3 style="text-align: center">Pemantauan TL BPK</h3>
<div class="col-12">
    <div class="">
        <div class="form-group">
            ...
            <div class="float-right">
                <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-block-normal">
                    Tambah Temuan
                </button>
            </div>
        </div> 
        ...
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header" style="background-color: #D10102;">
                    <h3 class="block-title">Tambah Temuan TL BPK</h3>
                ...
                <div class="block-content font-size-sm">
                    <div class="card-body">
                        <form method="POST" action="{{ route('bpk.pemantauan') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group custom-file hdtuto control-group lst" style="margin-top:10px" >
                                    <div class="">
                                        <input type="file" id="berkas" name="berkas" class="myfrm form-control custom-file-input" data-toggle="custom-file-input" value="{{ old('berkas') }}">

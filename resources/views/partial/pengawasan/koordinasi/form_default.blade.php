...
<a id="button-koordinasi" onclick="myKoordinasi()" type="" class="btn btn-sm btn-primary" style="font-size: 30px;margin: 55px 0; color: #FFFFFF">
    Ajukan Sosialisasi
</a>

<div id="columkoordinasi1" style="display: none" class="col-12">
    <div class="col-6">
        ...
        <div class="form-group">
            <label for="wizard-simple-lastname">Judul Sosialiasi</label><span class="text-danger">*</span>
...
<div id="columkoordinasi2" style="display: none" class="col-12">
    <div class="col-12">
        <div class="form-group">
...
<div id="columkoordinasi4" style="display: none" class="block-header block-header-default">
